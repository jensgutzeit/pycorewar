...
u64_t *run_88(insn_t *core, warrior_t *warriors, u32_t coresize,
	      u32_t maxprocesses, u32_t maxcycles, u32_t mindistance,
	      u32_t numrounds, u32_t seed);
u64_t *p_run_88(insn_t *core, warrior_t *warriors, u32_t coresize,
	        u32_t maxprocesses, u32_t maxcycles, u32_t mindistance);
u64_t *mw_run_88(insn_t *core, u32_t numwarriors, warrior_t *warriors,
